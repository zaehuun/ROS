#include <ros/ros.h>
#include "service_tutorials/SrvTutorial.h"
...
int main(int argc, char** argv){
	...
	ros::ServiceClient service_client = nh.serviceClient<service_tutorials::SrvTutorial>("ros_tutorial_srv");

	service_tutorials::SrvTutorial srv;
