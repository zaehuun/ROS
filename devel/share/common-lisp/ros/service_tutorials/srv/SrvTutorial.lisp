...
(cl:in-package service_tutorials-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTutorial-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTutorial-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name service_tutorials-srv:<SrvTutorial-request> is deprecated: use service_tutorials-srv:SrvTutorial-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <SrvTutorial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_tutorials-srv:a-val is deprecated.  Use service_tutorials-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SrvTutorial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_tutorials-srv:b-val is deprecated.  Use service_tutorials-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTutorial-request>)))
  ...
  "service_tutorials/SrvTutorialRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial-request)))
  "Returns string type for a service object of type 'SrvTutorial-request"
  "service_tutorials/SrvTutorialRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTutorial-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTutorial-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name service_tutorials-srv:<SrvTutorial-response> is deprecated: use service_tutorials-srv:SrvTutorial-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SrvTutorial-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_tutorials-srv:result-val is deprecated.  Use service_tutorials-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTutorial-response>)))
  ...
  "service_tutorials/SrvTutorialResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial-response)))
  "Returns string type for a service object of type 'SrvTutorial-response"
  "service_tutorials/SrvTutorialResponse")
