...
(cl:in-package marker_visualizer-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <marker_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'marker_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name marker_visualizer-msg:<marker_info> is deprecated: use marker_visualizer-msg:marker_info instead.")))

(cl:ensure-generic-function 'shape-val :lambda-list '(m))
(cl:defmethod shape-val ((m <marker_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader marker_visualizer-msg:shape-val is deprecated.  Use marker_visualizer-msg:shape instead.")
  (shape m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <marker_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader marker_visualizer-msg:x-val is deprecated.  Use marker_visualizer-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <marker_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader marker_visualizer-msg:y-val is deprecated.  Use marker_visualizer-msg:y instead.")
  (y m))
